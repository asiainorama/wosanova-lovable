  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        className,
        {
          "!duration-100 !transition-all": className?.includes("fast-animation")
        }
      )}
      {...props}
    >
      {children}
      {/* Comment out the default X button since we're managing our own close button in the Calculator component */}
